This is a readme for 0x18-dynamic_libraries directory.
The directory contains:
libdynamic.so - the dynamic library libdynamic.so containing all the functions listed below:
...
101-make_me_win.sh - a lottery cheating program
